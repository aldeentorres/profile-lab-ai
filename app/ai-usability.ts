...
export type AiUsabilitySignals={faceCount:number;faceHeightPixels:number;faceClarity:number;structureScore:number;focusScore:number;fidelityScore:number;faceClearance:number;qualityDefects:QualityDefect[]};
